    ...
    <div className="min-h-[calc(100vh-80px)] space-y-8 bg-gray-50 p-8">
      ...
      <section className="rounded-3xl border border-gray-100 bg-white p-6 shadow-sm">
        ...
        <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-4">
          {topFields.length === 0 ? (
            <div className="rounded-2xl border border-dashed border-gray-200 bg-gray-50 p-8 text-center text-sm text-gray-500 md:col-span-2 xl:col-span-4">
            ...
            topFields.map((field) => (
              <article
                key={field._id}
                className="rounded-2xl border border-gray-100 bg-gradient-to-br from-white to-emerald-50/40 p-5 shadow-sm transition hover:shadow-md"
              >
                <div className="mb-4 flex items-start justify-between gap-3">
                  <div>
                    <h4 className="font-bold text-gray-800">{field.name}</h4>
                    <p className="mt-1 text-sm text-gray-500 line-clamp-1" title={field.address}>
                ...
                <div className="flex flex-wrap gap-2 text-xs font-semibold">
                  ...
                  <span className="rounded-full bg-white px-3 py-1 text-green-700 ring-1 ring-green-200 bg-green-50">
